...
def box(args):
    ...
    return Transformer(2, encoder, decoder_box)


BuildModel.add(4, box)
...
class Transformer(CaptioningModel):
    def __init__(self, bos_idx, encoder, decoder_box, decoder_cap=None):
    ...
    def forward(self, images, seq =None, only_box = False):
