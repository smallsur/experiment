...
from models.rstnet import Transformer, TransformerEncoder, TransformerDecoderLayer, ScaledDotProductAttention, language_model
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ty',type=bool,default=False)

    # parser.add_argument('--gup_id',type=str,default='0,1')
    ...
    path_=['features_path','annotation_folder','dir_to_save_model','logs_folder','language_model_path']
    for p in path_:
